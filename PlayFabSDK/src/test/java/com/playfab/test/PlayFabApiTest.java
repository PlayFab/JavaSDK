...
public class PlayFabApiTest
{
    ...
    private static PlayFabEntityModels.EntityKey entityKey = null;
    ...
    public void GetEntityToken()
    {
        ...
        assertEquals(result.Result.Entity.Type.toString(), "title_player_account");
    ...
    public void ObjectApi()
    {
        ...
        PlayFabEntityModels.ObjectResult tempObjResult = null;
        ...
        setObjRequest.Entity = entityKey;
