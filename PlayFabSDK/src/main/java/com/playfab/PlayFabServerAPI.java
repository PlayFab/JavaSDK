...
public class PlayFabServerAPI {
    ...
    private static PlayFabResult<DeletePlayerCustomPropertiesResult> privateDeletePlayerCustomPropertiesAsync(final DeletePlayerCustomPropertiesRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL("/Server/DeletePlayerCustomProperties"), request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if (httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<GetPlayerCustomPropertyResult> privateGetPlayerCustomPropertyAsync(final GetPlayerCustomPropertyRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL("/Server/GetPlayerCustomProperty"), request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if (httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<GetPlayFabIDsFromPSNOnlineIDsResult> privateGetPlayFabIDsFromPSNOnlineIDsAsync(final GetPlayFabIDsFromPSNOnlineIDsRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL("/Server/GetPlayFabIDsFromPSNOnlineIDs"), request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if (httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<GetPlayFabIDsFromSteamNamesResult> privateGetPlayFabIDsFromSteamNamesAsync(final GetPlayFabIDsFromSteamNamesRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL("/Server/GetPlayFabIDsFromSteamNames"), request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if (httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<GetSegmentPlayerCountResult> privateGetSegmentPlayerCountAsync(final GetSegmentPlayerCountRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL("/Server/GetSegmentPlayerCount"), request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if (httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<EmptyResult>> LinkBattleNetAccountAsync(final LinkBattleNetAccountRequest request) {
        return new FutureTask(new Callable<PlayFabResult<EmptyResult>>() {
            public PlayFabResult<EmptyResult> call() throws Exception {
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<EmptyResult> LinkBattleNetAccount(final LinkBattleNetAccountRequest request) {
        FutureTask<PlayFabResult<EmptyResult>> task = new FutureTask(new Callable<PlayFabResult<EmptyResult>>() {
            public PlayFabResult<EmptyResult> call() throws Exception {
                return privateLinkBattleNetAccountAsync(request);
            }
    ...
    /** Links the Battle.net account associated with the token to the user's PlayFab account. */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<EmptyResult> privateLinkBattleNetAccountAsync(final LinkBattleNetAccountRequest request) throws Exception {
        if (PlayFabSettings.DeveloperSecretKey == null) throw new Exception ("Must have PlayFabSettings.DeveloperSecretKey set to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL("/Server/LinkBattleNetAccount"), request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if (httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<LinkPSNAccountResult> privateLinkPSNAccountAsync(final LinkPSNAccountRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL("/Server/LinkPSNAccount"), request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if (httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<ListPlayerCustomPropertiesResult> privateListPlayerCustomPropertiesAsync(final ListPlayerCustomPropertiesRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL("/Server/ListPlayerCustomProperties"), request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if (httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
     ...
     * @param request LoginWithBattleNetRequest
     * @return Async Task will return ServerLoginResult
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<ServerLoginResult>> LoginWithBattleNetAsync(final LoginWithBattleNetRequest request) {
        return new FutureTask(new Callable<PlayFabResult<ServerLoginResult>>() {
            public PlayFabResult<ServerLoginResult> call() throws Exception {
                return privateLoginWithBattleNetAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<ServerLoginResult> LoginWithBattleNet(final LoginWithBattleNetRequest request) {
        FutureTask<PlayFabResult<ServerLoginResult>> task = new FutureTask(new Callable<PlayFabResult<ServerLoginResult>>() {
            public PlayFabResult<ServerLoginResult> call() throws Exception {
                return privateLoginWithBattleNetAsync(request);
            }
    ...
    /** Sign in the user with a Battle.net identity token */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<ServerLoginResult> privateLoginWithBattleNetAsync(final LoginWithBattleNetRequest request) throws Exception {
        if (PlayFabSettings.DeveloperSecretKey == null) throw new Exception ("Must have PlayFabSettings.DeveloperSecretKey set to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL("/Server/LoginWithBattleNet"), request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if (httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<EmptyResponse> privateUnlinkBattleNetAccountAsync(final UnlinkBattleNetAccountRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL("/Server/UnlinkBattleNetAccount"), request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if (httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<UnlinkPSNAccountResult> privateUnlinkPSNAccountAsync(final UnlinkPSNAccountRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL("/Server/UnlinkPSNAccount"), request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if (httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<UpdatePlayerCustomPropertiesResult> privateUpdatePlayerCustomPropertiesAsync(final UpdatePlayerCustomPropertiesRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL("/Server/UpdatePlayerCustomProperties"), request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if (httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
