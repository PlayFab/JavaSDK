...
public class PlayFabSettings {
    public static String SdkVersion = "0.138.210927";
    public static String BuildIdentifier = "jbuild_javasdk_sdk-generic-3_1";
    public static String SdkVersionString = "JavaSDK-0.138.210927";
