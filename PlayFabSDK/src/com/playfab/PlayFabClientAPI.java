...
public class PlayFabClientAPI {
    ...
    private static PlayFabResult<GetPlayFabIDsFromPSNAccountIDsResult> privateGetPlayFabIDsFromPSNAccountIDsAsync(final GetPlayFabIDsFromPSNAccountIDsRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/GetPlayFabIDsFromPSNAccountIDs", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<LinkPSNAccountResult> privateLinkPSNAccountAsync(final LinkPSNAccountRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/LinkPSNAccount", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<LinkXboxAccountResult> privateLinkXboxAccountAsync(final LinkXboxAccountRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/LinkXboxAccount", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<UnlinkPSNAccountResult> privateUnlinkPSNAccountAsync(final UnlinkPSNAccountRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/UnlinkPSNAccount", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<UnlinkXboxAccountResult> privateUnlinkXboxAccountAsync(final UnlinkXboxAccountRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/UnlinkXboxAccount", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<ConsumePSNEntitlementsResult> privateConsumePSNEntitlementsAsync(final ConsumePSNEntitlementsRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/ConsumePSNEntitlements", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<EmptyResult>> RefreshPSNAuthTokenAsync(final RefreshPSNAuthTokenRequest request) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<EmptyResult> RefreshPSNAuthToken(final RefreshPSNAuthTokenRequest request) {
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<EmptyResult> privateRefreshPSNAuthTokenAsync(final RefreshPSNAuthTokenRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/RefreshPSNAuthToken", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<ApproveGuildRoleChangeResult>> ApproveGuildRoleChangeAsync(final ApproveGuildRoleChangeRequest request) {
        return new FutureTask(new Callable<PlayFabResult<ApproveGuildRoleChangeResult>>() {
            public PlayFabResult<ApproveGuildRoleChangeResult> call() throws Exception {
                return privateApproveGuildRoleChangeAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<ApproveGuildRoleChangeResult> ApproveGuildRoleChange(final ApproveGuildRoleChangeRequest request) {
        FutureTask<PlayFabResult<ApproveGuildRoleChangeResult>> task = new FutureTask(new Callable<PlayFabResult<ApproveGuildRoleChangeResult>>() {
            public PlayFabResult<ApproveGuildRoleChangeResult> call() throws Exception {
                return privateApproveGuildRoleChangeAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<ApproveGuildRoleChangeResult> privateApproveGuildRoleChangeAsync(final ApproveGuildRoleChangeRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/ApproveGuildRoleChange", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<ApproveGuildRoleChangeResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<ApproveGuildRoleChangeResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<ApproveGuildRoleChangeResult>>(){}.getType());
        ApproveGuildRoleChangeResult result = resultData.data;

        PlayFabResult<ApproveGuildRoleChangeResult> pfResult = new PlayFabResult<ApproveGuildRoleChangeResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<ChangeGuildMemberRoleResult>> ChangeGuildMemberRoleAsync(final ChangeGuildMemberRoleRequest request) {
        return new FutureTask(new Callable<PlayFabResult<ChangeGuildMemberRoleResult>>() {
            public PlayFabResult<ChangeGuildMemberRoleResult> call() throws Exception {
                return privateChangeGuildMemberRoleAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<ChangeGuildMemberRoleResult> ChangeGuildMemberRole(final ChangeGuildMemberRoleRequest request) {
        FutureTask<PlayFabResult<ChangeGuildMemberRoleResult>> task = new FutureTask(new Callable<PlayFabResult<ChangeGuildMemberRoleResult>>() {
            public PlayFabResult<ChangeGuildMemberRoleResult> call() throws Exception {
                return privateChangeGuildMemberRoleAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<ChangeGuildMemberRoleResult> privateChangeGuildMemberRoleAsync(final ChangeGuildMemberRoleRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/ChangeGuildMemberRole", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<ChangeGuildMemberRoleResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<ChangeGuildMemberRoleResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<ChangeGuildMemberRoleResult>>(){}.getType());
        ChangeGuildMemberRoleResult result = resultData.data;

        PlayFabResult<ChangeGuildMemberRoleResult> pfResult = new PlayFabResult<ChangeGuildMemberRoleResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<CreateGuildResult>> CreateGuildAsync(final CreateGuildRequest request) {
        return new FutureTask(new Callable<PlayFabResult<CreateGuildResult>>() {
            public PlayFabResult<CreateGuildResult> call() throws Exception {
                return privateCreateGuildAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<CreateGuildResult> CreateGuild(final CreateGuildRequest request) {
        FutureTask<PlayFabResult<CreateGuildResult>> task = new FutureTask(new Callable<PlayFabResult<CreateGuildResult>>() {
            public PlayFabResult<CreateGuildResult> call() throws Exception {
                return privateCreateGuildAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<CreateGuildResult> privateCreateGuildAsync(final CreateGuildRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/CreateGuild", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<CreateGuildResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<CreateGuildResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<CreateGuildResult>>(){}.getType());
        CreateGuildResult result = resultData.data;

        PlayFabResult<CreateGuildResult> pfResult = new PlayFabResult<CreateGuildResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<DeleteGuildResult>> DeleteGuildAsync(final DeleteGuildRequest request) {
        return new FutureTask(new Callable<PlayFabResult<DeleteGuildResult>>() {
            public PlayFabResult<DeleteGuildResult> call() throws Exception {
                return privateDeleteGuildAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<DeleteGuildResult> DeleteGuild(final DeleteGuildRequest request) {
        FutureTask<PlayFabResult<DeleteGuildResult>> task = new FutureTask(new Callable<PlayFabResult<DeleteGuildResult>>() {
            public PlayFabResult<DeleteGuildResult> call() throws Exception {
                return privateDeleteGuildAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<DeleteGuildResult> privateDeleteGuildAsync(final DeleteGuildRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/DeleteGuild", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<DeleteGuildResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<DeleteGuildResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<DeleteGuildResult>>(){}.getType());
        DeleteGuildResult result = resultData.data;

        PlayFabResult<DeleteGuildResult> pfResult = new PlayFabResult<DeleteGuildResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<DenyGuildRoleChangeResult>> DenyGuildRoleChangeAsync(final DenyGuildRoleChangeRequest request) {
        return new FutureTask(new Callable<PlayFabResult<DenyGuildRoleChangeResult>>() {
            public PlayFabResult<DenyGuildRoleChangeResult> call() throws Exception {
                return privateDenyGuildRoleChangeAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<DenyGuildRoleChangeResult> DenyGuildRoleChange(final DenyGuildRoleChangeRequest request) {
        FutureTask<PlayFabResult<DenyGuildRoleChangeResult>> task = new FutureTask(new Callable<PlayFabResult<DenyGuildRoleChangeResult>>() {
            public PlayFabResult<DenyGuildRoleChangeResult> call() throws Exception {
                return privateDenyGuildRoleChangeAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<DenyGuildRoleChangeResult> privateDenyGuildRoleChangeAsync(final DenyGuildRoleChangeRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/DenyGuildRoleChange", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<DenyGuildRoleChangeResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<DenyGuildRoleChangeResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<DenyGuildRoleChangeResult>>(){}.getType());
        DenyGuildRoleChangeResult result = resultData.data;

        PlayFabResult<DenyGuildRoleChangeResult> pfResult = new PlayFabResult<DenyGuildRoleChangeResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<GetGuildDataResult>> GetGuildDataAsync(final GetGuildDataRequest request) {
        return new FutureTask(new Callable<PlayFabResult<GetGuildDataResult>>() {
            public PlayFabResult<GetGuildDataResult> call() throws Exception {
                return privateGetGuildDataAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<GetGuildDataResult> GetGuildData(final GetGuildDataRequest request) {
        FutureTask<PlayFabResult<GetGuildDataResult>> task = new FutureTask(new Callable<PlayFabResult<GetGuildDataResult>>() {
            public PlayFabResult<GetGuildDataResult> call() throws Exception {
                return privateGetGuildDataAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<GetGuildDataResult> privateGetGuildDataAsync(final GetGuildDataRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/GetGuildData", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<GetGuildDataResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<GetGuildDataResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<GetGuildDataResult>>(){}.getType());
        GetGuildDataResult result = resultData.data;

        PlayFabResult<GetGuildDataResult> pfResult = new PlayFabResult<GetGuildDataResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<GetGuildInventoryResult>> GetGuildInventoryAsync(final GetGuildInventoryRequest request) {
        return new FutureTask(new Callable<PlayFabResult<GetGuildInventoryResult>>() {
            public PlayFabResult<GetGuildInventoryResult> call() throws Exception {
                return privateGetGuildInventoryAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<GetGuildInventoryResult> GetGuildInventory(final GetGuildInventoryRequest request) {
        FutureTask<PlayFabResult<GetGuildInventoryResult>> task = new FutureTask(new Callable<PlayFabResult<GetGuildInventoryResult>>() {
            public PlayFabResult<GetGuildInventoryResult> call() throws Exception {
                return privateGetGuildInventoryAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<GetGuildInventoryResult> privateGetGuildInventoryAsync(final GetGuildInventoryRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/GetGuildInventory", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<GetGuildInventoryResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<GetGuildInventoryResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<GetGuildInventoryResult>>(){}.getType());
        GetGuildInventoryResult result = resultData.data;

        PlayFabResult<GetGuildInventoryResult> pfResult = new PlayFabResult<GetGuildInventoryResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<GetGuildMembershipLeaderboardResult>> GetGuildMembershipLeaderboardAsync(final GetGuildMembershipLeaderboardRequest request) {
        return new FutureTask(new Callable<PlayFabResult<GetGuildMembershipLeaderboardResult>>() {
            public PlayFabResult<GetGuildMembershipLeaderboardResult> call() throws Exception {
                return privateGetGuildMembershipLeaderboardAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<GetGuildMembershipLeaderboardResult> GetGuildMembershipLeaderboard(final GetGuildMembershipLeaderboardRequest request) {
        FutureTask<PlayFabResult<GetGuildMembershipLeaderboardResult>> task = new FutureTask(new Callable<PlayFabResult<GetGuildMembershipLeaderboardResult>>() {
            public PlayFabResult<GetGuildMembershipLeaderboardResult> call() throws Exception {
                return privateGetGuildMembershipLeaderboardAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<GetGuildMembershipLeaderboardResult> privateGetGuildMembershipLeaderboardAsync(final GetGuildMembershipLeaderboardRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/GetGuildMembershipLeaderboard", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<GetGuildMembershipLeaderboardResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<GetGuildMembershipLeaderboardResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<GetGuildMembershipLeaderboardResult>>(){}.getType());
        GetGuildMembershipLeaderboardResult result = resultData.data;

        PlayFabResult<GetGuildMembershipLeaderboardResult> pfResult = new PlayFabResult<GetGuildMembershipLeaderboardResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<GetGuildDataResult>> GetGuildReadOnlyDataAsync(final GetGuildDataRequest request) {
        return new FutureTask(new Callable<PlayFabResult<GetGuildDataResult>>() {
            public PlayFabResult<GetGuildDataResult> call() throws Exception {
                return privateGetGuildReadOnlyDataAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<GetGuildDataResult> GetGuildReadOnlyData(final GetGuildDataRequest request) {
        FutureTask<PlayFabResult<GetGuildDataResult>> task = new FutureTask(new Callable<PlayFabResult<GetGuildDataResult>>() {
            public PlayFabResult<GetGuildDataResult> call() throws Exception {
                return privateGetGuildReadOnlyDataAsync(request);
            }
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<GetGuildDataResult> privateGetGuildReadOnlyDataAsync(final GetGuildDataRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/GetGuildReadOnlyData", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<GetGuildsLeaderboardResult>> GetGuildsLeaderboardAsync(final GetGuildsLeaderboardRequest request) {
        return new FutureTask(new Callable<PlayFabResult<GetGuildsLeaderboardResult>>() {
            public PlayFabResult<GetGuildsLeaderboardResult> call() throws Exception {
                return privateGetGuildsLeaderboardAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<GetGuildsLeaderboardResult> GetGuildsLeaderboard(final GetGuildsLeaderboardRequest request) {
        FutureTask<PlayFabResult<GetGuildsLeaderboardResult>> task = new FutureTask(new Callable<PlayFabResult<GetGuildsLeaderboardResult>>() {
            public PlayFabResult<GetGuildsLeaderboardResult> call() throws Exception {
                return privateGetGuildsLeaderboardAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<GetGuildsLeaderboardResult> privateGetGuildsLeaderboardAsync(final GetGuildsLeaderboardRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/GetGuildsLeaderboard", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<GetGuildsLeaderboardResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<GetGuildsLeaderboardResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<GetGuildsLeaderboardResult>>(){}.getType());
        GetGuildsLeaderboardResult result = resultData.data;

        PlayFabResult<GetGuildsLeaderboardResult> pfResult = new PlayFabResult<GetGuildsLeaderboardResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<GetGuildsLeaderboardAroundGuildResult>> GetGuildsLeaderboardAroundGuildAsync(final GetGuildsLeaderboardAroundGuildRequest request) {
        return new FutureTask(new Callable<PlayFabResult<GetGuildsLeaderboardAroundGuildResult>>() {
            public PlayFabResult<GetGuildsLeaderboardAroundGuildResult> call() throws Exception {
                return privateGetGuildsLeaderboardAroundGuildAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<GetGuildsLeaderboardAroundGuildResult> GetGuildsLeaderboardAroundGuild(final GetGuildsLeaderboardAroundGuildRequest request) {
        FutureTask<PlayFabResult<GetGuildsLeaderboardAroundGuildResult>> task = new FutureTask(new Callable<PlayFabResult<GetGuildsLeaderboardAroundGuildResult>>() {
            public PlayFabResult<GetGuildsLeaderboardAroundGuildResult> call() throws Exception {
                return privateGetGuildsLeaderboardAroundGuildAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<GetGuildsLeaderboardAroundGuildResult> privateGetGuildsLeaderboardAroundGuildAsync(final GetGuildsLeaderboardAroundGuildRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/GetGuildsLeaderboardAroundGuild", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<GetGuildsLeaderboardAroundGuildResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<GetGuildsLeaderboardAroundGuildResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<GetGuildsLeaderboardAroundGuildResult>>(){}.getType());
        GetGuildsLeaderboardAroundGuildResult result = resultData.data;

        PlayFabResult<GetGuildsLeaderboardAroundGuildResult> pfResult = new PlayFabResult<GetGuildsLeaderboardAroundGuildResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<GetGuildStatisticsResult>> GetGuildStatisticsAsync(final GetGuildStatisticsRequest request) {
        return new FutureTask(new Callable<PlayFabResult<GetGuildStatisticsResult>>() {
            public PlayFabResult<GetGuildStatisticsResult> call() throws Exception {
                return privateGetGuildStatisticsAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<GetGuildStatisticsResult> GetGuildStatistics(final GetGuildStatisticsRequest request) {
        FutureTask<PlayFabResult<GetGuildStatisticsResult>> task = new FutureTask(new Callable<PlayFabResult<GetGuildStatisticsResult>>() {
            public PlayFabResult<GetGuildStatisticsResult> call() throws Exception {
                return privateGetGuildStatisticsAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<GetGuildStatisticsResult> privateGetGuildStatisticsAsync(final GetGuildStatisticsRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/GetGuildStatistics", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<GetGuildStatisticsResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<GetGuildStatisticsResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<GetGuildStatisticsResult>>(){}.getType());
        GetGuildStatisticsResult result = resultData.data;

        PlayFabResult<GetGuildStatisticsResult> pfResult = new PlayFabResult<GetGuildStatisticsResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<GetLeaderboardOfPlayersGuildsResult>> GetLeaderboardOfPlayersGuildsAsync(final GetLeaderboardOfPlayersGuildsRequest request) {
        return new FutureTask(new Callable<PlayFabResult<GetLeaderboardOfPlayersGuildsResult>>() {
            public PlayFabResult<GetLeaderboardOfPlayersGuildsResult> call() throws Exception {
                return privateGetLeaderboardOfPlayersGuildsAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<GetLeaderboardOfPlayersGuildsResult> GetLeaderboardOfPlayersGuilds(final GetLeaderboardOfPlayersGuildsRequest request) {
        FutureTask<PlayFabResult<GetLeaderboardOfPlayersGuildsResult>> task = new FutureTask(new Callable<PlayFabResult<GetLeaderboardOfPlayersGuildsResult>>() {
            public PlayFabResult<GetLeaderboardOfPlayersGuildsResult> call() throws Exception {
                return privateGetLeaderboardOfPlayersGuildsAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<GetLeaderboardOfPlayersGuildsResult> privateGetLeaderboardOfPlayersGuildsAsync(final GetLeaderboardOfPlayersGuildsRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/GetLeaderboardOfPlayersGuilds", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<GetLeaderboardOfPlayersGuildsResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<GetLeaderboardOfPlayersGuildsResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<GetLeaderboardOfPlayersGuildsResult>>(){}.getType());
        GetLeaderboardOfPlayersGuildsResult result = resultData.data;

        PlayFabResult<GetLeaderboardOfPlayersGuildsResult> pfResult = new PlayFabResult<GetLeaderboardOfPlayersGuildsResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<LeaveGuildResult>> LeaveGuildAsync(final LeaveGuildRequest request) {
        return new FutureTask(new Callable<PlayFabResult<LeaveGuildResult>>() {
            public PlayFabResult<LeaveGuildResult> call() throws Exception {
                return privateLeaveGuildAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<LeaveGuildResult> LeaveGuild(final LeaveGuildRequest request) {
        FutureTask<PlayFabResult<LeaveGuildResult>> task = new FutureTask(new Callable<PlayFabResult<LeaveGuildResult>>() {
            public PlayFabResult<LeaveGuildResult> call() throws Exception {
                return privateLeaveGuildAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<LeaveGuildResult> privateLeaveGuildAsync(final LeaveGuildRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/LeaveGuild", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<LeaveGuildResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<LeaveGuildResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<LeaveGuildResult>>(){}.getType());
        LeaveGuildResult result = resultData.data;

        PlayFabResult<LeaveGuildResult> pfResult = new PlayFabResult<LeaveGuildResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<ListGuildMembersResult>> ListGuildMembersAsync(final ListGuildMembersRequest request) {
        return new FutureTask(new Callable<PlayFabResult<ListGuildMembersResult>>() {
            public PlayFabResult<ListGuildMembersResult> call() throws Exception {
                return privateListGuildMembersAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<ListGuildMembersResult> ListGuildMembers(final ListGuildMembersRequest request) {
        FutureTask<PlayFabResult<ListGuildMembersResult>> task = new FutureTask(new Callable<PlayFabResult<ListGuildMembersResult>>() {
            public PlayFabResult<ListGuildMembersResult> call() throws Exception {
                return privateListGuildMembersAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<ListGuildMembersResult> privateListGuildMembersAsync(final ListGuildMembersRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/ListGuildMembers", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<ListGuildMembersResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<ListGuildMembersResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<ListGuildMembersResult>>(){}.getType());
        ListGuildMembersResult result = resultData.data;

        PlayFabResult<ListGuildMembersResult> pfResult = new PlayFabResult<ListGuildMembersResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<ListPendingGuildRoleChangeRequestsResult>> ListPendingGuildRoleChangeRequestsAsync(final ListPendingGuildRoleChangeRequestsRequest request) {
        return new FutureTask(new Callable<PlayFabResult<ListPendingGuildRoleChangeRequestsResult>>() {
            public PlayFabResult<ListPendingGuildRoleChangeRequestsResult> call() throws Exception {
                return privateListPendingGuildRoleChangeRequestsAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<ListPendingGuildRoleChangeRequestsResult> ListPendingGuildRoleChangeRequests(final ListPendingGuildRoleChangeRequestsRequest request) {
        FutureTask<PlayFabResult<ListPendingGuildRoleChangeRequestsResult>> task = new FutureTask(new Callable<PlayFabResult<ListPendingGuildRoleChangeRequestsResult>>() {
            public PlayFabResult<ListPendingGuildRoleChangeRequestsResult> call() throws Exception {
                return privateListPendingGuildRoleChangeRequestsAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<ListPendingGuildRoleChangeRequestsResult> privateListPendingGuildRoleChangeRequestsAsync(final ListPendingGuildRoleChangeRequestsRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/ListPendingGuildRoleChangeRequests", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<ListPendingGuildRoleChangeRequestsResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<ListPendingGuildRoleChangeRequestsResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<ListPendingGuildRoleChangeRequestsResult>>(){}.getType());
        ListPendingGuildRoleChangeRequestsResult result = resultData.data;

        PlayFabResult<ListPendingGuildRoleChangeRequestsResult> pfResult = new PlayFabResult<ListPendingGuildRoleChangeRequestsResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<ListPlayerGuildMembershipsResult>> ListPlayerGuildMembershipsAsync(final ListPlayerGuildMembershipsRequest request) {
        return new FutureTask(new Callable<PlayFabResult<ListPlayerGuildMembershipsResult>>() {
            public PlayFabResult<ListPlayerGuildMembershipsResult> call() throws Exception {
                return privateListPlayerGuildMembershipsAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<ListPlayerGuildMembershipsResult> ListPlayerGuildMemberships(final ListPlayerGuildMembershipsRequest request) {
        FutureTask<PlayFabResult<ListPlayerGuildMembershipsResult>> task = new FutureTask(new Callable<PlayFabResult<ListPlayerGuildMembershipsResult>>() {
            public PlayFabResult<ListPlayerGuildMembershipsResult> call() throws Exception {
                return privateListPlayerGuildMembershipsAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<ListPlayerGuildMembershipsResult> privateListPlayerGuildMembershipsAsync(final ListPlayerGuildMembershipsRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/ListPlayerGuildMemberships", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<ListPlayerGuildMembershipsResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<ListPlayerGuildMembershipsResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<ListPlayerGuildMembershipsResult>>(){}.getType());
        ListPlayerGuildMembershipsResult result = resultData.data;

        PlayFabResult<ListPlayerGuildMembershipsResult> pfResult = new PlayFabResult<ListPlayerGuildMembershipsResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<RemoveGuildMemberResult>> RemoveGuildMemberAsync(final RemoveGuildMemberRequest request) {
        return new FutureTask(new Callable<PlayFabResult<RemoveGuildMemberResult>>() {
            public PlayFabResult<RemoveGuildMemberResult> call() throws Exception {
                return privateRemoveGuildMemberAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<RemoveGuildMemberResult> RemoveGuildMember(final RemoveGuildMemberRequest request) {
        FutureTask<PlayFabResult<RemoveGuildMemberResult>> task = new FutureTask(new Callable<PlayFabResult<RemoveGuildMemberResult>>() {
            public PlayFabResult<RemoveGuildMemberResult> call() throws Exception {
                return privateRemoveGuildMemberAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<RemoveGuildMemberResult> privateRemoveGuildMemberAsync(final RemoveGuildMemberRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/RemoveGuildMember", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<RemoveGuildMemberResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<RemoveGuildMemberResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<RemoveGuildMemberResult>>(){}.getType());
        RemoveGuildMemberResult result = resultData.data;

        PlayFabResult<RemoveGuildMemberResult> pfResult = new PlayFabResult<RemoveGuildMemberResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<RequestGuildRoleChangeResult>> RequestGuildRoleChangeAsync(final RequestGuildRoleChangeRequest request) {
        return new FutureTask(new Callable<PlayFabResult<RequestGuildRoleChangeResult>>() {
            public PlayFabResult<RequestGuildRoleChangeResult> call() throws Exception {
                return privateRequestGuildRoleChangeAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<RequestGuildRoleChangeResult> RequestGuildRoleChange(final RequestGuildRoleChangeRequest request) {
        FutureTask<PlayFabResult<RequestGuildRoleChangeResult>> task = new FutureTask(new Callable<PlayFabResult<RequestGuildRoleChangeResult>>() {
            public PlayFabResult<RequestGuildRoleChangeResult> call() throws Exception {
                return privateRequestGuildRoleChangeAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<RequestGuildRoleChangeResult> privateRequestGuildRoleChangeAsync(final RequestGuildRoleChangeRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/RequestGuildRoleChange", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<RequestGuildRoleChangeResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<RequestGuildRoleChangeResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<RequestGuildRoleChangeResult>>(){}.getType());
        RequestGuildRoleChangeResult result = resultData.data;

        PlayFabResult<RequestGuildRoleChangeResult> pfResult = new PlayFabResult<RequestGuildRoleChangeResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<UpdateGuildDataResult>> UpdateGuildDataAsync(final UpdateGuildDataRequest request) {
        return new FutureTask(new Callable<PlayFabResult<UpdateGuildDataResult>>() {
            public PlayFabResult<UpdateGuildDataResult> call() throws Exception {
                return privateUpdateGuildDataAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<UpdateGuildDataResult> UpdateGuildData(final UpdateGuildDataRequest request) {
        FutureTask<PlayFabResult<UpdateGuildDataResult>> task = new FutureTask(new Callable<PlayFabResult<UpdateGuildDataResult>>() {
            public PlayFabResult<UpdateGuildDataResult> call() throws Exception {
                return privateUpdateGuildDataAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<UpdateGuildDataResult> privateUpdateGuildDataAsync(final UpdateGuildDataRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/UpdateGuildData", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<UpdateGuildDataResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<UpdateGuildDataResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<UpdateGuildDataResult>>(){}.getType());
        UpdateGuildDataResult result = resultData.data;

        PlayFabResult<UpdateGuildDataResult> pfResult = new PlayFabResult<UpdateGuildDataResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<UpdateGuildStatisticsResult>> UpdateGuildStatisticsAsync(final UpdateGuildStatisticsRequest request) {
        return new FutureTask(new Callable<PlayFabResult<UpdateGuildStatisticsResult>>() {
            public PlayFabResult<UpdateGuildStatisticsResult> call() throws Exception {
                return privateUpdateGuildStatisticsAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<UpdateGuildStatisticsResult> UpdateGuildStatistics(final UpdateGuildStatisticsRequest request) {
        FutureTask<PlayFabResult<UpdateGuildStatisticsResult>> task = new FutureTask(new Callable<PlayFabResult<UpdateGuildStatisticsResult>>() {
            public PlayFabResult<UpdateGuildStatisticsResult> call() throws Exception {
                return privateUpdateGuildStatisticsAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<UpdateGuildStatisticsResult> privateUpdateGuildStatisticsAsync(final UpdateGuildStatisticsRequest request) throws Exception {
        if (_authKey == null) throw new Exception ("Must be logged in to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Client/UpdateGuildStatistics", request, "X-Authorization", _authKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<UpdateGuildStatisticsResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<UpdateGuildStatisticsResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<UpdateGuildStatisticsResult>>(){}.getType());
        UpdateGuildStatisticsResult result = resultData.data;

        PlayFabResult<UpdateGuildStatisticsResult> pfResult = new PlayFabResult<UpdateGuildStatisticsResult>();
        pfResult.Result = result;
        return pfResult;
    }
