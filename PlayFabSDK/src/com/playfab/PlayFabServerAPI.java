...
public class PlayFabServerAPI {
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<ModifyGuildVirtualCurrencyResult>> AddGuildVirtualCurrencyAsync(final AddGuildVirtualCurrencyRequest request) {
        return new FutureTask(new Callable<PlayFabResult<ModifyGuildVirtualCurrencyResult>>() {
            public PlayFabResult<ModifyGuildVirtualCurrencyResult> call() throws Exception {
                return privateAddGuildVirtualCurrencyAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<ModifyGuildVirtualCurrencyResult> AddGuildVirtualCurrency(final AddGuildVirtualCurrencyRequest request) {
        FutureTask<PlayFabResult<ModifyGuildVirtualCurrencyResult>> task = new FutureTask(new Callable<PlayFabResult<ModifyGuildVirtualCurrencyResult>>() {
            public PlayFabResult<ModifyGuildVirtualCurrencyResult> call() throws Exception {
                return privateAddGuildVirtualCurrencyAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<ModifyGuildVirtualCurrencyResult> privateAddGuildVirtualCurrencyAsync(final AddGuildVirtualCurrencyRequest request) throws Exception {
        if (PlayFabSettings.DeveloperSecretKey == null) throw new Exception ("Must have PlayFabSettings.DeveloperSecretKey set to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Server/AddGuildVirtualCurrency", request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<ModifyGuildVirtualCurrencyResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<ModifyGuildVirtualCurrencyResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<ModifyGuildVirtualCurrencyResult>>(){}.getType());
        ModifyGuildVirtualCurrencyResult result = resultData.data;

        PlayFabResult<ModifyGuildVirtualCurrencyResult> pfResult = new PlayFabResult<ModifyGuildVirtualCurrencyResult>();
        pfResult.Result = result;
        return pfResult;
    }
    ...
    private static PlayFabResult<GetGuildDataResult> privateGetGuildDataAsync(final GetGuildDataRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Server/GetGuildData", request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<GetGuildDataResult>> GetGuildInternalDataAsync(final GetGuildDataRequest request) {
        return new FutureTask(new Callable<PlayFabResult<GetGuildDataResult>>() {
            public PlayFabResult<GetGuildDataResult> call() throws Exception {
                return privateGetGuildInternalDataAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<GetGuildDataResult> GetGuildInternalData(final GetGuildDataRequest request) {
        FutureTask<PlayFabResult<GetGuildDataResult>> task = new FutureTask(new Callable<PlayFabResult<GetGuildDataResult>>() {
            public PlayFabResult<GetGuildDataResult> call() throws Exception {
                return privateGetGuildInternalDataAsync(request);
            }
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<GetGuildDataResult> privateGetGuildInternalDataAsync(final GetGuildDataRequest request) throws Exception {
        if (PlayFabSettings.DeveloperSecretKey == null) throw new Exception ("Must have PlayFabSettings.DeveloperSecretKey set to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Server/GetGuildInternalData", request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<GetGuildDataResult> privateGetGuildReadOnlyDataAsync(final GetGuildDataRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Server/GetGuildReadOnlyData", request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<GetGuildStatisticsResult> privateGetGuildStatisticsAsync(final GetGuildStatisticsRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Server/GetGuildStatistics", request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<GrantItemsToGuildResult>> GrantItemsToGuildAsync(final GrantItemsToGuildRequest request) {
        return new FutureTask(new Callable<PlayFabResult<GrantItemsToGuildResult>>() {
            public PlayFabResult<GrantItemsToGuildResult> call() throws Exception {
                return privateGrantItemsToGuildAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<GrantItemsToGuildResult> GrantItemsToGuild(final GrantItemsToGuildRequest request) {
        FutureTask<PlayFabResult<GrantItemsToGuildResult>> task = new FutureTask(new Callable<PlayFabResult<GrantItemsToGuildResult>>() {
            public PlayFabResult<GrantItemsToGuildResult> call() throws Exception {
                return privateGrantItemsToGuildAsync(request);
            }
        });
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<GrantItemsToGuildResult> privateGrantItemsToGuildAsync(final GrantItemsToGuildRequest request) throws Exception {
        if (PlayFabSettings.DeveloperSecretKey == null) throw new Exception ("Must have PlayFabSettings.DeveloperSecretKey set to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Server/GrantItemsToGuild", request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
            if (PlayFabSettings.GlobalErrorHandler != null)
                PlayFabSettings.GlobalErrorHandler.callback(error);
            PlayFabResult result = new PlayFabResult<GrantItemsToGuildResult>();
            result.Error = error;
            return result;
        }
        String resultRawJson = (String) httpResult;

        PlayFabJsonSuccess<GrantItemsToGuildResult> resultData = gson.fromJson(resultRawJson, new TypeToken<PlayFabJsonSuccess<GrantItemsToGuildResult>>(){}.getType());
        GrantItemsToGuildResult result = resultData.data;

        PlayFabResult<GrantItemsToGuildResult> pfResult = new PlayFabResult<GrantItemsToGuildResult>();
        pfResult.Result = result;
        return pfResult;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<ModifyGuildVirtualCurrencyResult>> SubtractGuildVirtualCurrencyAsync(final SubtractGuildVirtualCurrencyRequest request) {
        return new FutureTask(new Callable<PlayFabResult<ModifyGuildVirtualCurrencyResult>>() {
            public PlayFabResult<ModifyGuildVirtualCurrencyResult> call() throws Exception {
                return privateSubtractGuildVirtualCurrencyAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<ModifyGuildVirtualCurrencyResult> SubtractGuildVirtualCurrency(final SubtractGuildVirtualCurrencyRequest request) {
        FutureTask<PlayFabResult<ModifyGuildVirtualCurrencyResult>> task = new FutureTask(new Callable<PlayFabResult<ModifyGuildVirtualCurrencyResult>>() {
            public PlayFabResult<ModifyGuildVirtualCurrencyResult> call() throws Exception {
                return privateSubtractGuildVirtualCurrencyAsync(request);
            }
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<ModifyGuildVirtualCurrencyResult> privateSubtractGuildVirtualCurrencyAsync(final SubtractGuildVirtualCurrencyRequest request) throws Exception {
        if (PlayFabSettings.DeveloperSecretKey == null) throw new Exception ("Must have PlayFabSettings.DeveloperSecretKey set to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Server/SubtractGuildVirtualCurrency", request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<UpdateGuildDataResult> privateUpdateGuildDataAsync(final UpdateGuildDataRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Server/UpdateGuildData", request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<UpdateGuildDataResult>> UpdateGuildInternalDataAsync(final UpdateGuildDataRequest request) {
        return new FutureTask(new Callable<PlayFabResult<UpdateGuildDataResult>>() {
            public PlayFabResult<UpdateGuildDataResult> call() throws Exception {
                return privateUpdateGuildInternalDataAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<UpdateGuildDataResult> UpdateGuildInternalData(final UpdateGuildDataRequest request) {
        FutureTask<PlayFabResult<UpdateGuildDataResult>> task = new FutureTask(new Callable<PlayFabResult<UpdateGuildDataResult>>() {
            public PlayFabResult<UpdateGuildDataResult> call() throws Exception {
                return privateUpdateGuildInternalDataAsync(request);
            }
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<UpdateGuildDataResult> privateUpdateGuildInternalDataAsync(final UpdateGuildDataRequest request) throws Exception {
        if (PlayFabSettings.DeveloperSecretKey == null) throw new Exception ("Must have PlayFabSettings.DeveloperSecretKey set to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Server/UpdateGuildInternalData", request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
     ...
     */
    @SuppressWarnings("unchecked")
    public static FutureTask<PlayFabResult<UpdateGuildDataResult>> UpdateGuildReadOnlyDataAsync(final UpdateGuildDataRequest request) {
        return new FutureTask(new Callable<PlayFabResult<UpdateGuildDataResult>>() {
            public PlayFabResult<UpdateGuildDataResult> call() throws Exception {
                return privateUpdateGuildReadOnlyDataAsync(request);
            }
        });
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static PlayFabResult<UpdateGuildDataResult> UpdateGuildReadOnlyData(final UpdateGuildDataRequest request) {
        FutureTask<PlayFabResult<UpdateGuildDataResult>> task = new FutureTask(new Callable<PlayFabResult<UpdateGuildDataResult>>() {
            public PlayFabResult<UpdateGuildDataResult> call() throws Exception {
                return privateUpdateGuildReadOnlyDataAsync(request);
            }
     ...
     */
    @SuppressWarnings("unchecked")
    private static PlayFabResult<UpdateGuildDataResult> privateUpdateGuildReadOnlyDataAsync(final UpdateGuildDataRequest request) throws Exception {
        if (PlayFabSettings.DeveloperSecretKey == null) throw new Exception ("Must have PlayFabSettings.DeveloperSecretKey set to call this method");

        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Server/UpdateGuildReadOnlyData", request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
    ...
    private static PlayFabResult<UpdateGuildStatisticsResult> privateUpdateGuildStatisticsAsync(final UpdateGuildStatisticsRequest request) throws Exception {
        ...
        FutureTask<Object> task = PlayFabHTTP.doPost(PlayFabSettings.GetURL() + "/Server/UpdateGuildStatistics", request, "X-SecretKey", PlayFabSettings.DeveloperSecretKey);
        task.run();
        Object httpResult = task.get();
        if(httpResult instanceof PlayFabError) {
            PlayFabError error = (PlayFabError)httpResult;
