...
public class PlayFabSettings {
    public static String SdkVersion = "0.139.211012";
    public static String BuildIdentifier = "jbuild_javasdk_sdk-generic-3_2";
    public static String SdkVersionString = "JavaSDK-0.139.211012";
