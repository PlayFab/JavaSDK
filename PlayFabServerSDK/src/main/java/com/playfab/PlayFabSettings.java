...
public class PlayFabSettings {
    public static String SdkVersion = "0.135.210816";
    public static String BuildIdentifier = "jbuild_javasdk_sdk-generic-2_1";
    public static String SdkVersionString = "JavaSDK-0.135.210816";
