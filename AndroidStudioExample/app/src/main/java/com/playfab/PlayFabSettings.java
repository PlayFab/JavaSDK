...
public class PlayFabSettings {
    public static String SdkVersion = "0.90.190509";
    public static String BuildIdentifier = "jbuild_javasdk__sdk-genericslave-1_2";
    public static String SdkVersionString = "JavaSDK-0.90.190509";
